...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-06-2019 a las 04:34:32
...
(29, 'ricardo', 'ricardoarjona@gmail.com');
...
ALTER TABLE `registrados`
  ...
  ADD UNIQUE KEY `correo_registrados` (`correo_registrados`);
...
--
ALTER TABLE `registrados`
  MODIFY `ID_registrados` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
