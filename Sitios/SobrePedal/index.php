	...
	<section id="seccion1">
		...
		<div class="contedor_txt">
			...
			<div class="CuadroTxt">
				<p> 
					<br>
				Es momento de conocer a los amigos de mi abuelo, las personas más influyentes del ciclismo. Con este reloj, podré ir al pasado y así enterarme de lo que realmente sucedió en esas épocas.
				</p>
...
<i class="btnTxt b5 anima fas fa-comment"></i>
	...
	<section id="seccion5">
		...
		<div class="juego">
			...
			<a href="sobre_pedal/php/juego.php" target="_blank"> 
			<button  target="_blank"class="btn"  style=" background-color: #faa854; opacity: 0.1; position: relative; width: 20%; height: 100px; font-size: 40;  margin-left: -580px; margin-top:
			319px; ; z-index: 5;" >
