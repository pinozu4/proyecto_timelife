	...
	<div class="contenedor">
		...
		<section>
			<table class="table table-striped">
				<thead>
					<tr>
						<th scope="col"> <span style="color: #0c8dd0"># </span> </th>
						<th scope="col"> <span style="color: #0c8dd0">Nombre</span> </th>
						<th scope="col"> <span style="color: #0c8dd0">Edad</span> </th>
						<th scope="col"> <span style="color: #0c8dd0">Correo</span> </th>
						<th scope="col"></th>
						<th scope="col"> <span style="color: #0c8dd0; display: flex;justify-content: center;align-items: center;">Acción</span> </th>
					</tr>
				</thead>
				<tbody>
					<?php
					while ($row = mysqli_fetch_array($result)){
						...
						<td>".$row['edad']."</td>
						<td>".$row['correo']."</td>
						<td><a href='editorU.php?idUser=".$row["id"]."' class='btn btn-success'>Editar</a></td>
						<td><a href='eliminarU.php?idUser=".$row["id"]."' class='btn btn-danger'>Eliminar</a></td>
						<td><a href='emailU.php?idUser=".$row["id"]."' class='btn btn-warning'>Enviar Correo</a></td>
					</tr>";
					}
					?>
				</tbody>
