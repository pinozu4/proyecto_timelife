...
<body>
	<div class="contenedor">
		...
		<section style="display: flex; justify-content: center; align-items: center; flex-flow: column wrap; text-align: center;">
			<form action="updateU.php" method="post" class="w-100">
				<div class="form-group">
					<label for="nombre">Nombre</label>
					<input type="text" class="form-control" name="nombre" id="nombre" placeholder="Titulo" value="<?php echo $row['nombre']; ?>">
				</div>
				<div class="form-group">
					<label for="edad">Edad</label>
					<input type="number" class="form-control" name="edad" id="edad" placeholder="Edad" value="<?php echo $row['edad']?>">
				</div>

				<div class="form-group">
					<label for="email">Texto 2</label>
					<input type="email" class="form-control" name="email" id="email" placeholder="Email" value="<?php echo $row['correo']?>">
				</div>
